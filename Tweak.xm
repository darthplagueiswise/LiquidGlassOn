...
// ---- NSUserDefaults override (force LiquidGlass* keys) -------------------
...
__attribute__((constructor)) static void EGInit(void) {
    @autoreleasepool {
        // Force meta keys immediately (via SharedModules providers)
        ...
        // Override NSUserDefaults lookups for any *LiquidGlass* keys
